...
class CDPTaskAutomationWorkflow {
    ...
    async initializeBrowser() {
        try {
            ...
            this.log('💡 Make sure Chrome is running with --remote-debugging-port=9223', 'INFO');
            this.log('🔧 Try running: google-chrome --remote-debugging-port=9223 --user-data-dir=/tmp/chrome-debug', 'INFO');
            throw error;
        }
    }
