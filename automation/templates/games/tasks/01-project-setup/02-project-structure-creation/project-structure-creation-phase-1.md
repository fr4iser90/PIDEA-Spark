# [TASK_NAME] – Phase [NUMBER]: [PHASE_TITLE]
...
- [ ] [OBJECTIVE_3] - [DESCRIPTION]
- [ ] [OBJECTIVE_4] - [DESCRIPTION]
- [ ] [OBJECTIVE_5] - [DESCRIPTION]

## 📦 Phase Deliverables

### Code Files
- [ ] `[FILE_PATH_1]` - [DESCRIPTION] (e.g., Core game system, UI component, Asset loader)
- [ ] `[FILE_PATH_2]` - [DESCRIPTION] (e.g., Configuration file, Utility function, Test file)
- [ ] `[FILE_PATH_3]` - [DESCRIPTION] (e.g., API endpoint, Database schema, Documentation)

### Game Assets
- [ ] `[ASSET_PATH_1]` - [DESCRIPTION] (e.g., Texture, Model, Audio file, Animation)
- [ ] `[ASSET_PATH_2]` - [DESCRIPTION] (e.g., UI sprite, Sound effect, Particle system)
- [ ] `[ASSET_PATH_3]` - [DESCRIPTION] (e.g., Level data, Configuration, Localization)

### Tests & Documentation
- [ ] `[TEST_PATH_1]` - [DESCRIPTION] (e.g., Unit test, Integration test, Performance test)
- [ ] `[DOC_PATH_1]` - [DESCRIPTION] (e.g., API documentation, User manual, Technical spec)

## 🔗 Phase Dependencies
- **Requires**: [DEPENDENCIES] (e.g., Phase X completion, External library, Asset delivery)
...
- [ ] [CRITERIA_1] - [MEASURABLE_OUTCOME] (e.g., Feature works correctly, Performance target met)
- [ ] [CRITERIA_2] - [MEASURABLE_OUTCOME] (e.g., Tests pass, Documentation complete)
- [ ] [CRITERIA_3] - [MEASURABLE_OUTCOME] (e.g., Code review approved, Integration successful)
- [ ] [CRITERIA_4] - [MEASURABLE_OUTCOME] (e.g., Asset quality verified, Performance optimized)
- [ ] [CRITERIA_5] - [MEASURABLE_OUTCOME] (e.g., User testing passed, Bug-free implementation)
...
## 🔄 Phase Rollback Plan
- [ ] [ROLLBACK_ITEM_1] - [DESCRIPTION] (e.g., Revert code changes, Restore previous version)
- [ ] [ROLLBACK_ITEM_2] - [DESCRIPTION] (e.g., Remove new assets, Disable feature flag)
- [ ] [ROLLBACK_ITEM_3] - [DESCRIPTION] (e.g., Update configuration, Restore database)
...
---
*Template: Game Development Phase - [CATEGORY]*
